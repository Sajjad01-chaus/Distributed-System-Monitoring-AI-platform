...
class SystemMonitorAgent:
    ...
    async def collect_all_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            metrics['cpu'] = await self.system_collector.get_cpu_metrics()
            metrics['memory'] = await self.system_collector.get_memory_metrics()
            metrics['disk'] = await self.filesystem_collector.get_disk_metrics()
            
            # Network metrics
            metrics['network'] = await self.network_collector.get_network_metrics()
